            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-600">Select students and assign them to specific subjects.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.student-subjects.store') }}" id="assignment-form">
                        ...
                        <div class="flex items-center justify-end">
                            <a href="{{ route('admin.student-subjects.index') }}" class="mr-4 text-gray-600 hover:text-gray-800">
                                Cancel
                            </a>
...
classSelect.addEventListener('change', function() {
    ...
    if (classId && academicYearId) {
        ...
        loadStudents(classId, academicYearId); // Updated to pass academicYearId
    } else {
        subjectSelect.innerHTML = '<option value="">Select Subject</option>';
        studentsContainer.innerHTML = '<p class="text-gray-500 text-center">Please select academic year and class first</p>';
        ...
        function loadClasses(academicYearId) {
            fetch(`/admin/student-subjects/classes/${academicYearId}`)
                ...
                .then(data => {
                    ...
                    subjectSelect.innerHTML = '<option value="">Select Subject</option>';
                    studentsContainer.innerHTML = '<p class="text-gray-500 text-center">Please select a class</p>';
                    submitBtn.disabled = true;
                })
                .catch(error => {
                    ...
                    subjectSelect.innerHTML = '<option value="">Select Subject</option>';
                    studentsContainer.innerHTML = '<p class="text-red-500 text-center">Error loading classes</p>';
                    submitBtn.disabled = true;
                });
        }
    ...
    fetch(`/admin/student-subjects/students/${classId}/${academicYearId}`)
        ...
        .then(data => {
            ...
            if (data.length > 0) {
                ...
                studentsContainer.innerHTML = '<p class="text-gray-500 text-center">No students found in this class for the selected academic year</p>';
                submitBtn.disabled = true;
            }
        })
        .catch(error => {
            console.error('Error loading students:', error);
            studentsContainer.innerHTML = '<p class="text-red-500 text-center">Error loading students: ' + error.message + '</p>';
            submitBtn.disabled = true;
        });
}
    });
