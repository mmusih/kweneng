                    ...
                    <form method="POST" action="{{ route('admin.alumni.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="graduation_year" class="block mt-1 w-full" type="number" name="graduation_year" :value="old('graduation_year', date('Y') - 5)" min="1950" max="{{ date('Y') + 5 }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="current_occupation" class="block mt-1 w-full" type="text" name="current_occupation" :value="old('current_occupation')" />
