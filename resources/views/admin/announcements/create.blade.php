                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type"
                                        ...
                                        <option value="urgent" {{ old('type') == 'urgent' ? 'selected' : '' }}>Urgent
                                        </option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="audience" name="audience"
                                        ...
                                        <option value="all" {{ old('audience') == 'all' ? 'selected' : '' }}>All
                                            Users</option>
                                        <option value="parents" {{ old('audience') == 'parents' ? 'selected' : '' }}>
                                            Parents Only</option>
                                        <option value="teachers" {{ old('audience') == 'teachers' ? 'selected' : '' }}>
                                            Teachers Only</option>
                                        <option value="students" {{ old('audience') == 'students' ? 'selected' : '' }}>
                                            Students Only</option>
                                        <option value="specific_class"
                                            {{ old('audience') == 'specific_class' ? 'selected' : '' }}>Specific Class
                                        </option>
                                        <option value="specific_subject"
                                            {{ old('audience') == 'specific_subject' ? 'selected' : '' }}>Specific
                                            Subject</option>
                                    </select>
