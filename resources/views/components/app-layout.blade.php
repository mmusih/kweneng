...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-100 text-gray-900 transition-colors dark:bg-brand-900 dark:text-brand-200">
        <div class="min-h-screen bg-gray-100 transition-colors dark:bg-brand-900">
            <!-- Page Navigation -->
            @include('layouts.navigation')

            <!-- Page Heading -->
            @if (isset($header))
                <header class="bg-white shadow transition-colors dark:bg-brand-900 dark:shadow-none">
