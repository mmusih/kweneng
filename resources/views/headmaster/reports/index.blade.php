                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @foreach ($students as $student)
                                            <tr>
                                                <td class="px-4 py-3 text-sm text-gray-900">{{ $student->admission_no }}
                                                </td>
                                                <td class="px-4 py-3 text-sm text-gray-900">{{ $student->user->name }}
                                                </td>
                                                <td class="px-4 py-3 text-sm text-gray-900">
                                                    {{ $student->currentClass->name ?? 'N/A' }}</td>
                                                <td class="px-4 py-3 text-sm text-gray-900">
