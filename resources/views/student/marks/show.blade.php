    ...
    <x-slot name="header">
        <div class="mt-16 p-6 bg-white rounded-lg shadow-md border border-gray-200">
            <h2 class="font-bold text-2xl text-center text-gray-800 leading-tight">
                {{ $academicYear->year_name }} - {{ $term->name }}
            </h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6 flex justify-between items-center">
                        <div>
                            <h3 class="text-2xl font-semibold">Your Marks</h3>
                        ...
                        <a href="{{ route('student.marks.index') }}" class="text-indigo-600 hover:text-indigo-900 text-sm">
