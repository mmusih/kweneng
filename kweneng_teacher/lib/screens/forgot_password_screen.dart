...
class TeacherForgotPasswordScreen extends ConsumerStatefulWidget {
  const TeacherForgotPasswordScreen({super.key});

  @override
  ConsumerState<TeacherForgotPasswordScreen> createState() =>
      _TeacherForgotPasswordScreenState();
}

class _TeacherForgotPasswordScreenState
    extends ConsumerState<TeacherForgotPasswordScreen> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Enter the email used for your staff account. We will send a secure reset link if the account exists.',
                  textAlign: TextAlign.center,
