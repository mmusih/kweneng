...
class TermController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            // report card text fields
            'report_title' => 'nullable|string|max:255',
            'report_footer_note' => 'nullable|string|max:2000',
            'report_office_note' => 'nullable|string|max:2000',
            'report_extra_note' => 'nullable|string|max:2000',
        ]);
    ...
    public function update(Request $request, Term $term)
    {
        ...
        $validated = $request->validate([
            ...
            'start_date' => 'required|date',
            'end_date' => 'required|date|after:start_date',
            'status' => 'required|string|in:active,finalized,locked',
